...
<template>
    <AppLayout>
    <AuthBase title="Registre o candidato" description="Preencha as informações necessárias">
        <Head title="Candidato" />
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="Titulo_eleitor" type="text" required :tabindex="4" v-model="form.Titulo_eleitor" placeholder="Titulo de eleitor" />
